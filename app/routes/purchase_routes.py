    ...
    try:
        ...
        for receive_item in receive_data.items:
            ...
            if stock:
                ...
                print(f"Updated stock in branch {branch_id}: {product.name} +{receive_item.quantity_received}")
            else:
                stock = Stock(
                ...
                db.add(stock)
                print(f"Created new stock record in branch {branch_id}: {product.name} = {receive_item.quantity_received}")
